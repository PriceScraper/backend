...
VALUES (1,
        'https://static.ah.nl/dam/product/AHI_43545239383439303036?revLabel=3&rendition=800x800_JPG_Q90&fileType=binary',
        'zout,peper',
        'Pizza hawai', 1, 320, 0);
INSERT INTO ITEM(ID, IMAGE, INGREDIENTS, NAME, QUANTITY, CONTENT, TYPE)
VALUES (2,
        'https://static.ah.nl/dam/product/AHI_43545239383439323934?revLabel=3&rendition=800x800_JPG_Q90&fileType=binary',
        'zout,peper,kaas', 'Pizza margherita', 1, 320, 0);
